...
import static com.jd.atlas.client.ext.UserDefineAtlasNotificationBaseMessage.MESSAGE_COMPRESSION_ENABLED;
import static com.jd.atlas.client.ext.UserDefineAtlasNotificationBaseMessage.MESSAGE_MAX_LENGTH_BYTES;

/**
 * Abstract notification interface implementation.
 */
public abstract class UserDefineAbstractNotification implements UserDefineNotificationInterface {
    private static final Logger LOG = LoggerFactory.getLogger(UserDefineAbstractNotification.class);
    ...
    public UserDefineAbstractNotification(Configuration applicationProperties) throws AtlasException {
    }

    @VisibleForTesting
    protected UserDefineAbstractNotification() {
    }

    // ----- NotificationInterface -------------------------------------------

    @Override
    public <T> void send(UserDefineNotificationInterface.NotificationType type, List<T> messages) throws NotificationException {
    ...
    @Override
    public <T> void send(UserDefineNotificationInterface.NotificationType type, T... messages) throws NotificationException {
     ...
     */
    protected abstract void sendInternal(UserDefineNotificationInterface.NotificationType type, List<String> messages) throws NotificationException;
    ...
    public static void createNotificationMessages(Object message, List<String> msgJsonList) {
        UserDefineAtlasNotificationMessage<?> notificationMsg = new UserDefineAtlasNotificationMessage<>(CURRENT_MESSAGE_VERSION, message, getHostAddress(), getCurrentUser());
